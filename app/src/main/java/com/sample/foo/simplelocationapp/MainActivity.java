...
//                    LocationManager.GPS_PROVIDER, 30 * 60 * 1000, 5, locationListenerGPS);
                    LocationManager.GPS_PROVIDER, 3*1000, 0, locationListenerGPS);
...
//                locationManager.requestLocationUpdates(provider, 2 * 60 * 1000, 10, locationListenerBest);
                locationManager.requestLocationUpdates(provider, 3*1000, 0, locationListenerBest);
    ...
    public void toggleNetworkUpdates(View view) {
        ...
        if(button.getText().equals(getResources().getString(R.string.pause))) {
            ...
            locationManager.requestLocationUpdates(
                    LocationManager.NETWORK_PROVIDER, 3*1000, 0, locationListenerNetwork);
...
//            Log.w(TAG, "@@@@@@@@@you hae moved more than 30 m");
            ...
            double theDistance = distanceBetweenTwoPoint(oldLatitudeBest,oldLongitudeBest,latitudeBest, longitudeBest);
